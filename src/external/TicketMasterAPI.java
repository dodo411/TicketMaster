...
public class TicketMasterAPI implements ExternalAPI {
	...
	private static final String API_KEY = "SfpCuaZAlDXmpdCnIhMLj49Kibkd6fYo";
...
/*		// Get from “classifications” => “segment” => “name”
		...
		for (int i = 0; i < classifications.length(); i++) {
			set.add(classifications.getJSONObject(i).getJSONObject("segment").getString("name"));
		}
		return set;*/
		//return null;
	...
	public static void main(String[] args) {
		...
		// Fromnt, CA
		//tmApi.queryAPI(37.548270, -121.988572);
	}
